...
This page documents bundler integration choices around the Valyrian runtime, not a separate framework layer.
...
Expected outcome: both bundlers render the same app and complete production builds without JSX transform errors.
