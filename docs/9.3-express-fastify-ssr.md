...
Use it as an integration pattern for the browser/server runtime model, not as evidence that this repository ships a fully opinionated server meta-framework.
