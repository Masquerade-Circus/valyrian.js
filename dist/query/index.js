...
var QueryClient = class {
  ...
  constructor(options = {}) {
    ...
    this.#persistStore = options.persist ? (0, import_native_store.createNativeStore)(options.persistId || "valyrian-query", {}, import_native_store.StorageType.Local, true) : null;
    this.#rehydrate();
  }
  #emit(event) {
