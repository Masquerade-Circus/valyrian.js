...
(function(){
    let v = function (...args) {
        if (
            ...
            return v.render.apply(m,args);
        }

        return v.h.apply(v.h, args);
    };
    ...
    v.getKey = function(node) {
        return node && node.props ? node.props.key : null;
    };

    v.setElementProp = function(element, name, value, isSVG, oldValue) {
        if (name === "key") {
            return;
        }
    ...
    v.createElement = function(node, isSVG) {
        var name,
            i = 0,
    ...
    v.updateElement = function(element, oldProps, props, isSVG) {
        var name;
    ...
    v.removeChildren = function(element, node, props) {
        if (node !== undefined){
    ...
    v.removeElement = function(parent, element, node) {
    ...
    v.patch = function(parent, element, oldNode, node, isSVG, nextSibling) {
      if (node === oldNode) {
    ...
    v.mount = function(container, component, attributes = {}){
      ...
      this.root = v.isNode ? v.root : (container && container.children[0]);
    ...
    v.update = function(component, attributes = {}){
      ...
      return v.isNode ? this.root.outerHTML : this.root;
    };

    v.isComponent = function(component){
        return typeof component === 'object' && typeof component.view === 'function';
    };
